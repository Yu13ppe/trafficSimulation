...
function iniciarSimulacion(e) {
    ...
    var inicioSimulacion = new Date(fechaInicioParts[0], fechaInicioParts[1] - 1, fechaInicioParts[2]);
    ...
    var finSimulacion = new Date(fechaFinParts[0], fechaFinParts[1] - 1, fechaFinParts[2]);
